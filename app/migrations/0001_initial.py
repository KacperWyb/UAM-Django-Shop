# Generated by Django 2.2.12 on 2021-06-01 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Otrzymano zamówienie', 'Otrzymano zamówienie'), ('Przetwarzanie zamówienia', 'Przetwarzanie zamówienia'), ('W drodze', 'W drodze'), ('Zamówienie zrealizowane', 'Zamówienie zrealizowane'), ('Zamówienie anulowane', 'Zamówienie anulowane')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('payment_method', models.CharField(choices=[('Za pobraniem', 'Za pobraniem'), ('PayPal', 'PayPal'), ('Przelewy24', 'Przelewy24')], default='Za pobraniem', max_length=20)),
